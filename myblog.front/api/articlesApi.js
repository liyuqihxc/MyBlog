...
export default {
  ...
  async addNewPost (postID, published, { title, tags, category, content }) {
    let result = await http.post(`/api/articles/addnew?PostID=${postID}&Published=${published}`, { title, tags, category, content })
    return result
  },
